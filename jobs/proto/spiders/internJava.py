import scrapy
import os
class InternshipJavaSpider(scrapy.Spider):
    name = "internshipJava"
    allowed_domains = ["internshala.com"]
    custom_settings = {
        "FEEDS": {
            os.path.join("data", "JavaInternship.csv"): { 
                'format': 'csv'
            }
        }
    }
    ...
    def start_requests(self):
                url = "https://internshala.com/internships/java-internship/"
    ...
    def parse(self, response):
            ...
            for title in titles:
                    ...
                    follow_next_page = f"https://internshala.com/internships/java-internship/page-{count}/"
                    count+=1
                    b+=1
                    yield{
                            'title': t,
