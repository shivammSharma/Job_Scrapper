import scrapy
import os
class InternshipFrontEndSpider(scrapy.Spider):
    name = "internshipFront"
    allowed_domains = ["internshala.com"]
    custom_settings = {
        "FEEDS": {
            os.path.join("data", "FrontEndInternship.csv"): { 
                'format': 'csv'
            }
        }
    }
    ...
    def parse(self, response):
            ...
            for title in titles:
                    ...
                    follow_next_page = f"https://internshala.com/internships/front-end-development-internship/page-{count}/"
                    count+=1
                    b+=1
                    yield{
                            'title': t,
